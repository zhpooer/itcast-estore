...
<script type="text/javascript">
	...
	function validateRequired(fieldname) {
		...
		if (objval.match("^\\s*$") != null) {
			document.getElementById(fieldname + "_msg").innerHTML = "<span style='color:red'>"
					+ msg[fieldname] + "不能为空！</span>";
			return false;
		} else {
	...
	function validateForm() {
		...
		if (!isNameValid || !isfixedPriceValid || isSalePriceValid
				|| !isPnumValid || !isProductImgValid) {
			return false;
		}
	}
</script>
								...
								<div class="art-post-body">
									...
									<form method="post" enctype="multipart/form-data"
										...
										<table>
											...
											<tr>
												<td>Estore打折价格</td>
												<td><input type="text" name="estoreprice"
													id="sale_price" /></td>
											...
											<tr>
												<td>描述</td>
												<td><textarea rows="5" cols="80" name="description"
														id="description"></textarea></td>
												<td id="description_msg"></td>
											</tr>
											<tr>
												<td colspan="3"><input type="submit" value="添加商品" /></td>
											</tr>
										</table>
									</form>
									<!-- 添加商品表单结束 -->
