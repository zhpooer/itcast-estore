		...
		<TBODY>
			<TR>
				<TD vAlign=top height=270>
					<DIV align=center>
						<BR> <IMG height=211 src="images/error.gif" width=329><BR>
						<BR>
						<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
							<TBODY>
								...
								<TR>
									<TD>
										<P>
											<FONT color=#000000><BR> 服务器出现异常 ，异常信息 <%=exception.getClass().getName()%>
